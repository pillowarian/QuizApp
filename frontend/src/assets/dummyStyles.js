...
export const resultStyles = {
  // Page container
  pageContainer: "min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6 relative overflow-hidden",
  container: "max-w-6xl font-[pacifico] mx-auto relative z-10",
  
  // Header
  header: "mb-8 flex flex-col md:flex-row md:items-start md:justify-between gap-4 bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white",
  title: "text-3xl md:text-4xl lg:text-3xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent",
  ...
  filterLabel: "text-sm font-medium text-gray-700 mr-2",
  filterButton: "px-4 py-2 rounded-full text-sm font-medium border-2 shadow-sm focus:outline-none transition-all duration-300 hover:scale-105",
  filterButtonActive: "bg-gradient-to-r from-indigo-600 to-purple-600 text-white border-indigo-600 shadow-lg",
  filterButtonInactive: "bg-white text-gray-700 border-gray-200 hover:border-indigo-300 hover:bg-indigo-50",
  filterStatus: "text-sm text-gray-600 font-medium",
  
  // Loading state
  loadingContainer: "text-center py-20",
  loadingSpinner: "inline-block animate-spin rounded-full h-16 w-16 border-4 border-indigo-200 border-t-indigo-600 mb-4",
  loadingText: "text-gray-700 text-lg font-medium",
  
  // Track sections
  trackSection: "mb-8",
  trackTitle: "text-xl md:text-2xl lg:text-xl font-bold mb-4 text-gray-800 flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-xl inline-block shadow-sm",
  
  // Results grid
  resultsGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-6 lg:gap-6",
  
  // Empty state
  emptyState: "text-center py-16 text-gray-600 text-lg bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg",
  
  // Badge styles
  badgeExcellent: "inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-emerald-100 to-green-100 text-emerald-800 shadow-sm",
  badgeGood: "inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-indigo-100 to-blue-100 text-indigo-800 shadow-sm",
  badgeAverage: "inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 shadow-sm",
  badgeNeedsWork: "inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r from-red-100 to-pink-100 text-red-800 shadow-sm",
  
  // Card styles
  card: "relative bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-white hover:shadow-2xl hover:scale-105 transition-all duration-300 transform hover:-translate-y-1",
  cardAccent: "absolute left-0 top-0 bottom-0 w-2 bg-gradient-to-b from-indigo-400 via-purple-500 to-pink-600",
  cardContent: "p-5 md:p-6 lg:p-5 flex flex-col h-full",
  
  // Card header
  cardHeader: "flex items-start justify-between gap-4",
  cardInfo: "flex items-center gap-4 min-w-0",
  levelAvatar: "flex items-center justify-center w-14 h-14 md:w-16 md:h-16 lg:w-14 lg:h-14 rounded-xl font-bold text-xl md:text-2xl lg:text-xl shadow-md border-2 border-white",
  levelBasic: "bg-gradient-to-br from-indigo-100 to-indigo-200 text-indigo-700",
  levelIntermediate: "bg-gradient-to-br from-purple-100 to-purple-200 text-purple-700",
  levelAdvanced: "bg-gradient-to-br from-pink-100 to-pink-200 text-pink-700",
  cardText: "min-w-0",
  cardTitle: "text-base md:text-lg lg:text-base font-bold truncate text-gray-800",
  cardMeta: "text-xs md:text-sm lg:text-xs text-gray-600 font-medium",
  
  // Card performance
  cardPerformance: "text-right",
  performanceLabel: "text-xs md:text-sm lg:text-xs text-gray-600 font-medium mb-1",
  badgeContainer: "mt-1",
  
  // Card stats
  cardStats: "mt-5 pt-4 border-t-2 border-gray-100 flex justify-between gap-4",
  statItem: "text-sm md:text-base lg:text-sm text-gray-700 font-medium flex flex-col items-center",
  statNumber: "font-bold text-xl md:text-2xl lg:text-xl bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent"
};